                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                                style="line-height: 39.2px; font-size: 28px;">{{$name}}</span></strong></span></p>
                                                            </div>
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('public/frontend/images/image-8.png') }}" alt="Image"
                                                                            title="Image"
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:28px 33px 25px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 200%;"><span
                                                                        ...
                                                                        style="font-size: 16px; line-height: 32px;">{{$body}} </span></p>
                                                                <p style="font-size: 14px; line-height: 200%;"><span
                                                                        style="font-size: 16px; line-height: 32px;">Chúc bạn có những buổi học buổi học bổ ích tại trung tâm SHTP-Tranning</span></p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 0px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div align="center">
                                                                ...
                                                                <a href="" target="_blank"
                                                                    style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #272362; border-radius: 40px; -webkit-border-radius: 40px; -moz-border-radius: 40px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                                    <span
                                                                        style="display:block;padding:15px 44px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                                                    style="line-height: 19.2px; font-size: 16px;">Review
                                                                                    us on
                                                                                    Google</span></strong></span></span>
                                                                </a>
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('public/frontend/images/image-2.png') }}" alt="Image"
                                                                            title="Image"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:19px 33px 40px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div
                                                                style="color: #272362; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 24px; line-height: 33.6px;">Look
                                                                        forward to hearing from you </span><br /><span
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('public/frontend/images/image-3.png') }}"
                                                                                            alt="Facebook"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Twitter"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('public/frontend/images/image-6.png') }}.png"
                                                                                            alt="Twitter"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('public/frontend/images/image-7.png') }}"
                                                                                            alt="LinkedIn"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('public/frontend/images/image-4.png') }}"
                                                                                            alt="Instagram"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="YouTube"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('public/frontend/images/image-5.png') }}.png"
                                                                                            alt="YouTube"
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:23px 40px 10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">Call us:
                                                                    (84-28) 37 360 052<br />EMAIL:
                                                                    contact@shtp-training.edu.vn <br />Address: Lô E1 – Khu Công nghệ cao, Xa lộ Hà Nội, Phường Tân Phú, Quận 9, Thành phố Hồ Chí Minh</p>
                                                            </div>
